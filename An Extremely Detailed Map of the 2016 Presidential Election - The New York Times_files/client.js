...
define('nytint/email-subscriber',[
  ...
  var NotifyForm = React.createClass({displayName: "NotifyForm",
    ...
    subscribe: function(payload) {
      ...
      if(this.props.signupFormVersion) {
        payload.signup_form_version = this.props.signupFormVersion;
      }
      ...
      // return $.ajax('http://localhost.nytimes.com:9292/svc/int/email-subscriber/subscribe', {
        method: 'POST',
        data: payload,
        xhrFields: {
    ...
    unsubscribe: function(payload) {
      ...
      }).done(this.onUnsubSuccess).fail(this.onError);
    },
    ...
    render: function() {
      ...
      if(this.state.alreadySubscribed) {
        // var unsubMarkup = { __html: "<span>test</span>" };
        // var unsubscribeButton = <div dangerouslySetInnerHTML={unsubMarkup} />

      var subscribedView = React.createElement(UnsubButton, {unsubscribe: this.unsubscribe, 
      ...
      var showDisclaimer = window.location.href.match(/showdisclaimer/) || !isHomepage;
      if(showDisclaimer) {
        var disclaimer = React.createElement("div", {className: "disclaimer"}, 
            "You can opt out or ", React.createElement("a", {href: "https://www.nytimes.com/help/index.html#care", onClick: this.openHelpPage}, "contact us"), " anytime. ", React.createElement("a", {href: "https://help.nytimes.com/hc/en-us/articles/115014892108-Privacy-policy"}, "Privacy Policy"), " | ", React.createElement("a", {href: "https://help.nytimes.com/hc/en-us/articles/115014893428-Terms-of-service"}, "Terms of Service")
          );
      } else {
        var disclaimer = '';
      }
  ...
  var UnsubButton = React.createClass({displayName: "UnsubButton",
    onSubmit: function() {
      if (this.props.status == 'working') { return false; }
      this.props.onButtonClick();
    ...
    render: function() {
      ...
      return (
        React.createElement("div", null, 
          welcome, 
          React.createElement("button", {className: "notify-submit", className: "button", onClick: this.onSubmit}, React.createElement("span", null, this.props.text.unsubscribeButton))
        )
      );
    }
  });
    ...
    userData.ready(function() {
      React.render(
        React.createElement(NotifyForm, {loggedIn: userData.isLoggedIn(), 
                    ...
                    signupFormVersion: opts.signupFormVersion, 
                    text: text}),
