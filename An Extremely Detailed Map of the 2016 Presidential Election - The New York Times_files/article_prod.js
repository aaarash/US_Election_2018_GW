!(function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)})([(function(e,t,n){function i(){function e(e){var t=n(147),i=[t];i.push(n(149)),i.push(n(155)),i.push(n(158)),i.push(n(161)),i.push(n(163)),i.push(n(173)),i.push(n(176)),i.push(n(178)),i.push(n(181)),i.push(n(184)),i.push(n(188)),i.push(n(191)),i.push(n(195)),i.push(n(198)),i.push(n(202)),i.push(n(206)),i.push(n(211)),i.push(n(212)),i.push(n(213)),i.push(n(214)),i.push(n(215)),i.push(n(218)),i.push(n(222)),i.push(n(227)),i.push(n(228)),i.push(n(230)),i.push(n(231)),h.initialize({clientData:e,plugins:i})}function t(e,t,n){return"/dist/preview_data.js?token=__TOKEN__&preview_layer_ids=__PREVIEW_LAYER_IDS__".replace("__TOKEN__",e).replace("__PROJECT_ID__",t).replace("__PREVIEW_LAYER_IDS__",n.join(",")).replace("__GET_ONLY_PREVIEW_LAYERS__",!0)}window.performance&&window.performance.mark&&window.performance.mark("optimizely:blockBegin");var i=n(1);i.initialize();var r=n(82),a=n(23),o=n(16);n(126);var s=o.get("stores/directive"),u=n(88);if(!u.isCORSSupported())throw new Error("CORS is not supported on this browser, aborting.");var c,l=n(129),d=n(116),f=n(130),p={"layers": [{"holdback": 0, "activation": {}, "integrationSettings": {}, "integrationStringVersion": 2, "viewIds": ["9835610235"], "experiments": [{"weightDistributions": null, "audienceName": "Everyone else", "name": "JKidd Attribute Setting", "bucketingStrategy": null, "variations": [{"id": "10162090038", "actions": [{"viewId": "9835610235", "changes": [{"dependencies": [], "type": "custom_code", "id": "58D2330B-A5D7-4582-A2AC-9D98914400A1", "value": function($){if(window.NYToptly.jkidd){
...
window.nyt5Optly = nyt5Optly;
    ...
    CA: {
        mobile_collapsed_dock: '<strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>'
    },
    AU: {
        mobile_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>'
    }
};

window.exoOptly = exoOptly;
}, "dependencies": [], "type": "custom_code", "id": "649C9ED1-FD48-4976-9265-413F6A4158A0"}]}], "name": "Variation #1"}], "audienceIds": ["and", "11348210295"], "changes": null, "id": "11206485069", "integrationSettings": null}, {"weightDistributions": null, "audienceName": "[cookie] urgency2", "name": "NYT5 INYT & US sale Ends today", "bucketingStrategy": null, "variations": [{"id": "11319550175", "actions": [{"viewId": "8263601258", "changes": [{"value": function($){var exoOptly = {
    urgency: 'today',
    US: '<strong>Subscribe for $1 a week.</strong> <span style="white-space: nowrap">Ends today.</span>',    
    UK: {
        mobile_collapsed_dock: '<strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends today.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends today.</span>'
    },
    EU: {
        mobile_collapsed_dock: '<strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends today.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends today.</span>'
...
PluginManager.registerWidget({
      widgetId: '11069032928',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11069032928";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"redirect_url","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
    ...
    if (!widg.hasOwnProperty(field.name)) {
      widg[field.name] = field.default_value;
        ...
        var redirectUrl = widget.redirect_url,
    redirectUrlHasSearch = redirectUrl.indexOf('?') > -1,
    srcUrlSearch = window.location.search,
    srcUrlParams = null,
    redirectUrlParams = null,
    redirectUrlSearch = '',
    resultParams = null,
    redirectUrlHref = redirectUrl,
    resultUrl = '';

if (redirectUrlHasSearch) {
    redirectUrlSearch = redirectUrl.split('?')[1];
    redirectUrlParams = getParamsObject(redirectUrlSearch);
    redirectUrlHref = redirectUrl.split('?')[0];
}

if (srcUrlSearch) {
    srcUrlSearch = srcUrlSearch.slice(1);
    srcUrlParams = getParamsObject(srcUrlSearch);
}

resultParams = getResultParams(srcUrlParams, redirectUrlParams);
resultUrl = getRedirectUrl(resultParams, redirectUrlHref);

window.location.replace(resultUrl);

function getReferrer() {
    var url = window.location.href;
    var regex = new RegExp("[?&]referrer(=([^&#]*)|&|#|$)"),
        results = regex.exec(url);
    if (!results) return null;
    if (!results[2]) return "";
    return decodeURIComponent(results[2].replace(/\+/g, " "));
...
function getParamsObject(search) {
...
function getResultParams(srcParams, redirectParams) {
    var result = {};
    result.referrer = getReferrer() || document.referrer;
    if (redirectParams) {
        for (var redirectParam in redirectParams) {
            result[redirectParam] = redirectParams[redirectParam];
        }
    }
    if (srcParams) {
        for (var srcParam in srcParams) {
            if (!result.hasOwnProperty(srcParam)) {
                result[srcParam] = srcParams[srcParam];
            }
        }
    }
    return result;
...
function getRedirectUrl(params, url) {
    var result = '';
    var search = [];
    for (var p in params) {
        var el = p + (params[p] ? '=' + params[p] : '');
        search.push(el);
    }
    search = search.join('&');
    result = url + '?' + search;
...
PluginManager.registerWidget({
      widgetId: '11183882777',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11183882777";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"extra_js","default_value":""},{"name":"click1","default_value":""},{"name":"click2","default_value":""},{"name":"nytID","default_value":""},{"name":"creator","default_value":"nytExo"},{"name":"growl_meter","default_value":["4"]},{"name":"custom_js","default_value":""},{"name":"full_html","default_value":""},{"name":"css","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
    ...
    if (!widg.hasOwnProperty(field.name)) {
      widg[field.name] = field.default_value;
        ...
        console.log("Universal Growl Temp");
if (!!window.optimizely_p13n_inner ||
    window.location != window.parent.location &&
    window.location.search.indexOf('optimizely_editor') > -1) {
    var appendDiv = function(id) {
...
PluginManager.registerWidget({
      widgetId: '11285910250',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11285910250";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"creative_src","default_value":"https://mwcm-author.prd.nytimes.com/subscription/meteredassets/targetedGWandLP/gateway/control.html"},{"name":"nytId","default_value":""},{"name":"creator","default_value":"nytExo"},{"name":"abra_campaign","default_value":""},{"name":"external_js_1","default_value":""},{"name":"external_js_2","default_value":""},{"name":"inline_js","default_value":""},{"name":"external_css_1","default_value":""},{"name":"external_css_2","default_value":""},{"name":"containerHTML","default_value":""},{"name":"inline_css","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
...
var widgetObj = {
    name: 'Gateway',
    html: widget.containerHTML,
    selector: "#gatewayUnit",
    callback: function() {
        // because of CSS latency
        document.querySelector("#gatewayCreative").style.visibility = 'hidden';
        opt_console.log(logPrefix + 'setting #gatewayCreative to hidden.');

        var nytId = widget.nytId;
        ...
        var container = document.querySelector('#optimizelyMagnoliaContainer');
        var agent_id = window.NYToptly.userInfo && window.NYToptly.userInfo.agent_id;
        var utils = optimizely.get('utils');
        ...
        function loadStyle(css, flagName) {
            if (css !== '') {
                ...
                style.onload = function() {
                    opt_console.log(logPrefix + "Loaded style tag with content from: " + flagName);
        ...
        if (abraCampaign) {
            ...
            if (allocation) {
                ...
                opt_console.log(logPrefix + "in ABRA campaign: " + abraCampaign + ' -- ' + allocation + ".");
            }
        }
        ...
        function addCreative(creative) {
            ...
            utils.waitForElement('#optimizelyMagnoliaContainer').then(function() {
                ...
                var container = document.querySelector('#optimizelyMagnoliaContainer');
                container.innerHTML = mktInfo + creative;
                ...
                NYToptly.runWhenReady(
                    ...
                    function() {
                        document.querySelector("#gatewayCreative").style.visibility = 'visible';
                        opt_console.log(logPrefix + 'setting #gatewayCreative to visible.');
                    },
                    null, 100, 100
                );
                opt_console.log(logPrefix + ' Gateway Magnolia API Extension: ' + nytId);
            });
        }
...
PluginManager.registerWidget({
      widgetId: '11363074672',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11363074672";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"abra_test","default_value":""},{"name":"redirect_url","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
...
function addAbraToUrl(url) {
    if (!widget.abra_test) {
        return url;
    }
    var abraValue = getCookie(widget.abra_test);
    if (abraValue === null || abraValue === '') {
        return url;
    }
    return url + '&' + widget.abra_test + '=' + abraValue;
}
...
PluginManager.registerWidget({
      widgetId: '11368832181',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11368832181";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"abra_test","default_value":""},{"name":"messageType","default_value":"WelcomeAd"},{"name":"displayTime","default_value":7},{"name":"trackInOptimizely","default_value":"cta"},{"name":"extra_js","default_value":""},{"name":"click1","default_value":""},{"name":"click2","default_value":""},{"name":"click3","default_value":""},{"name":"click4","default_value":""},{"name":"nytID","default_value":" "},{"name":"creator","default_value":"nytExo"},{"name":"closeSelector","default_value":".nytdGrowlNotifyCross"},{"name":"session_cap","default_value":"1"},{"name":"session_cap_hours","default_value":24},{"name":"freq_cap_number","default_value":"3"},{"name":"freq_cap_days","default_value":365},{"name":"custom_js","default_value":""},{"name":"full_html","default_value":""},{"name":"css","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
    ...
    widget.full_html = window.NYToptly.getCountryText(widget.full_html);
    widget.full_html = widget.full_html.replace(/%%CLICKTHRU1%%/g, setAbraValueToUrl(widget.click1));
    widget.full_html = widget.full_html.replace(/%%CLICKTHRU2%%/g, setAbraValueToUrl(widget.click2));
    widget.full_html = widget.full_html.replace(/%%CLICKTHRU3%%/g, setAbraValueToUrl(widget.click3));
    widget.full_html = widget.full_html.replace(/%%CLICKTHRU4%%/g, setAbraValueToUrl(widget.click4));
...
PluginManager.registerWidget({
      widgetId: '11369121592',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11369121592";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"abra_test","default_value":""},{"name":"extra_js","default_value":""},{"name":"click1","default_value":""},{"name":"click2","default_value":""},{"name":"click3","default_value":""},{"name":"click4","default_value":""},{"name":"nytID","default_value":""},{"name":"creator","default_value":"nytExo"},{"name":"custom_js","default_value":""},{"name":"full_html","default_value":""},{"name":"css","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
    ...
    /* Set cookie for mobile redirect */
    if (abraValue !== null) {
        NYToptly.setCookie(widget.abra_test, abraValue, 10);
    }
    var setAbraValueToUrl = function(url) {
        if (abraValue === null || !url) {
            return url;
...
PluginManager.registerWidget({
      widgetId: '11372651558',
      showFn: function(event) {
        var $ = window.optimizely.get('jquery');
        var widget = event.data.config;
        var _template = new Hogan(function(c,p,i) {var t=this;t.b(i=i||"");return t.fl(); })
        widget.$id = "11372651558";
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"abra_test","default_value":""},{"name":"extra_js","default_value":""},{"name":"click1","default_value":""},{"name":"click2","default_value":""},{"name":"click3","default_value":""},{"name":"Click4","default_value":""},{"name":"nytID","default_value":""},{"name":"creator","default_value":"nytExo"},{"name":"growl_meter","default_value":"1"},{"name":"extra_js_2","default_value":""},{"name":"extra_js_3","default_value":""},{"name":"extra_js_4","default_value":""},{"name":"custom_js","default_value":""},{"name":"full_html","default_value":""},{"name":"css","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
